...
@section('content')
        ...
        <div id="utf_listing_gallery_part" class="utf_listing_section">
            <div class="utf_listing_slider utf_gallery_container margin-bottom-0">
                <a href="images/photography_listing_01.jpg" data-background-image="images/photography_listing_01.jpg" class="item utf_gallery"></a>
                <a href="images/photography_listing_02.jpg" data-background-image="images/photography_listing_02.jpg" class="item utf_gallery"></a>
                <a href="images/photography_listing_03.jpg" data-background-image="images/photography_listing_03.jpg" class="item utf_gallery"></a>
                <a href="images/photography_listing_04.jpg" data-background-image="images/photography_listing_04.jpg" class="item utf_gallery"></a>
            </div>
        </div>
                ...
                <div class="col-lg-8 col-md-8">
                    <div id="titlebar" class="utf_listing_titlebar">
                        <div class="utf_listing_titlebar_title">
                            <h2>Digital Photography Magazine <span class="listing-tag">Photographer</span></h2>
                    ...
                    <div class="utf_listing_section">
                        <h3 class="utf_listing_headline_part margin-top-50 margin-bottom-40">Wedding Pricing</h3>
                        <div class="show-more">
                            <div class="utf_pricing_list_section">
                                <h4>Wedding Photography Listing</h4>
                                <ul>
                                    <li>
                                        <h5>Basic Photography <sub class="ppl-offer label-light-success">25% Off</sub></h5>
                                        <p><strong>Max :</strong> 2 Photographers, 1 Photo Book, 1 Engagement Session</p>
                                        <span>$460</span>
                                    </li>
                                    <li>
                                        <h5>Standard Photography <sub class="ppl-offer label-light-success">25% Off</sub></h5>
                                        <p><strong>Max :</strong> 3 Photographers, 1 Photo Book, 1 Engagement Session</p>
                                        <span>$740</span>
                                    </li>
                                    <li>
                                        <h5>Premium Photography <sub class="ppl-offer label-light-success">25% Off</sub></h5>
                                        <p><strong>Max :</strong> 4 Photographers, 1 Photo Book, 1 Engagement Session</p>
                                        <span>$980</span>
                                    </li>
                                    <li>
                                        <h5><strong>Tatel Price</strong></h5>
                                        <span><strong>$2180</strong></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="utf_box_widget opening-hours margin-top-30">
                        ...
                        <form id="contactform">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input name="email" type="email" value="Email Address" placeholder="Email Address" required="">
                                </div>
                                <div class="col-md-12">
                                    <input name="phone" type="text" value="Phone Number" placeholder="Phone Number" required="">
                                </div>
                                <div class="col-md-12">

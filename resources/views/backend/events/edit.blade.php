                            ...
                            <div class="add_utf_listing_section margin-top-45">
                                ...
                                <div class="row with-forms">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="search-field" name="title" id="listing_title"
                                               placeholder="Titre" value="{{$events->title}}">
                                    </div>
                                    <div class="col-md-6">
                                        <h5>Adresse email</h5>
                                ...
                                <div class="row with-forms">
                                    <div class="col-md-12">
                                        ...
                                        <h5>Description</h5>
                                        <textarea name="description" cols="40" rows="3" id="summernote"
                                                  placeholder="Description..." spellcheck="true" >{{$events->description}}</textarea>
                                    ...
                                    <div class="row with-forms">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="input-text" name="adresse" id="address"
                                                   placeholder="Address" value="{{$events->adresse}}">
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            <div class="row with-forms">
                                                <div class="col-md-6">
                                                    <input type="text" class="input-text" name="latitude" id="latitude"
                                                           placeholder="40.7324319" value="{{$events->latitude}}">
                                                </div>
                                                <div class="col-md-6">
                                                    <input type="text" class="input-text" name="longitude"
                                                           id="longitude" placeholder="-73.824807777775" value="{{$events->longitude}}">
                                                </div>
                                            </div>
                                        </div>
